...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_DERIVE_KEYPAIR_FROM_MNEMONIC
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_DERIVE_KEYPAIR_FROM_MNEMONIC
RustBuffer uniffi_yttrium_fn_func_solana_derive_keypair_from_mnemonic(RustBuffer mnemonic, RustBuffer derivation_path, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_GENERATE_KEYPAIR
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_GENERATE_KEYPAIR
RustBuffer uniffi_yttrium_fn_func_solana_generate_keypair(RustCallStatus *_Nonnull out_status
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_PHANTOM_DERIVATION_PATH_WITH_ACCOUNT
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_PHANTOM_DERIVATION_PATH_WITH_ACCOUNT
RustBuffer uniffi_yttrium_fn_func_solana_phantom_derivation_path_with_account(uint32_t account, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_PUBKEY_FOR_KEYPAIR
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_PUBKEY_FOR_KEYPAIR
RustBuffer uniffi_yttrium_fn_func_solana_pubkey_for_keypair(RustBuffer keypair, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_SIGN_PREHASH
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_FN_FUNC_SOLANA_SIGN_PREHASH
RustBuffer uniffi_yttrium_fn_func_solana_sign_prehash(RustBuffer keypair, RustBuffer message, RustCallStatus *_Nonnull out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_DERIVE_KEYPAIR_FROM_MNEMONIC
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_DERIVE_KEYPAIR_FROM_MNEMONIC
uint16_t uniffi_yttrium_checksum_func_solana_derive_keypair_from_mnemonic(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_GENERATE_KEYPAIR
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_GENERATE_KEYPAIR
uint16_t uniffi_yttrium_checksum_func_solana_generate_keypair(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_PHANTOM_DERIVATION_PATH_WITH_ACCOUNT
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_PHANTOM_DERIVATION_PATH_WITH_ACCOUNT
uint16_t uniffi_yttrium_checksum_func_solana_phantom_derivation_path_with_account(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_PUBKEY_FOR_KEYPAIR
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_PUBKEY_FOR_KEYPAIR
uint16_t uniffi_yttrium_checksum_func_solana_pubkey_for_keypair(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_SIGN_PREHASH
#define UNIFFI_FFIDEF_UNIFFI_YTTRIUM_CHECKSUM_FUNC_SOLANA_SIGN_PREHASH
uint16_t uniffi_yttrium_checksum_func_solana_sign_prehash(void
